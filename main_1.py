if __name__ == "__main__":
    ...
    print("Hai selezionato la foto: " + nomeImmagine)
    ...
    Gaussian_Filter = Create_Gaussian_Filter(2)     ## Creazione Filtro
    ...
    print("Le modifiche sono state apportate in " + str(start - end) + " secondi")
